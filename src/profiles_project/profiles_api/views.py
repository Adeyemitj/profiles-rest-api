...
class LoginViewSet(viewsets.ViewSet):
    ...
    #set a serializer class to AuthTokenSerializer
...
# create a ProfileFeedItem ViewSet class to inherit ViewSet
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    """Handles creating, reading and updating profile feed items."""
    #create a tuple authentication class
    authentication_classes = (TokenAuthentication,)
    # set serializer class
    serializer_class = serializer.ProfileFeedItemSerializer
    # define queryset for users
